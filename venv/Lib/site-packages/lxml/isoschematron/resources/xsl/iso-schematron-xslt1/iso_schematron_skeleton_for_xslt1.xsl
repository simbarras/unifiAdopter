...
<!--
   ...
   The generated XSLT code can then be run against an XML files (*.xml, etc) and
...
>
    ...
    <xsl:template match="*" mode="stylesheetbody">
        ...
        <!-- These parameters may contain strings with the name and directory of the files being
