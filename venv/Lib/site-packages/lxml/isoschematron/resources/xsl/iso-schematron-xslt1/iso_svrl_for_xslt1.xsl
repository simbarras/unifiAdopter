...
<!-- 
  ...
  replaces any template with the same name in the imported skeleton XSLT files.)
  ...
  History:  
   ...
   2008-08-07
  	...
  	2008-08-06
    	...
    	* Output comment to SVRL files giving filename if available (from command-line parameter)
  	2008-08-04
...
>
   ...
   -->
    ...
    <!-- e.g. saxon files.xml files.xsl "sch.exslt.imports=.../string.xsl;.../math.xsl" -->
    <xsl:param name="sch.exslt.imports"/>


    <!-- Experimental: If this files called, then must be generating svrl -->
