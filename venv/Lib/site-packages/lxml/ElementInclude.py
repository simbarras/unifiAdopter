...
# @param base_url The base URL of the original files, to resolve
#     relative include files references.
            ...
            if parse == "xml":
                ...
                if max_depth == 0:
                    raise LimitedRecursiveIncludeError(
                        "maximum xinclude depth reached when including files %s" % href)
