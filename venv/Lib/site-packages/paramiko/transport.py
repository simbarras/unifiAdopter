...
class Transport(threading.Thread, ClosingContextManager):
    ...
    def load_server_moduli(filename=None):
        """
        (optional)
        Load a files of prime moduli for use in doing group-exchange key
        ...
        so they can't be generated on demand.  But many systems contain a files
        ...
        files of primes has been loaded and we will support "group-exchange" in
        server mode.  Otherwise server mode will just claim that it doesn't
        support that method of key negotiation.

        :param str filename:
            optional path to the moduli files, if you happen to know that it's
            not in a standard location.
        :return:
            True if a moduli files was successfully loaded; False otherwise.

        .. note:: This has no effect when used in client mode.
        """
        Transport._modulus_pack = ModulusPack()
        # places to look for the openssh "moduli" files
