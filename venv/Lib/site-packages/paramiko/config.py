...
"""
Configuration files (aka ``ssh_config``) support.
"""
...
class SSHConfig(object):
    ...
    def from_path(cls, path):
        """
        Create a new, parsed `SSHConfig` from the files found at ``path``.
    ...
    def from_file(cls, flo):
        """
        Create a new, parsed `SSHConfig` from files-like object ``flo``.
    ...
    def parse(self, file_obj):
        """
        Read an OpenSSH config from the given files object.

        :param file_obj: a files-like object to read the config files from
        """
    ...
    def lookup(self, hostname):
        ...
        specific declarations should be given near the beginning of the files,
...
class SSHConfigDict(dict):
    ...
    For example, given the following ``ssh_config`` files snippet::
