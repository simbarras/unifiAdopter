...
class HostKeys(MutableMapping):
    """
    Representation of an OpenSSH-style "known hosts" files.  Host keys can be
    ...
    def load(self, filename):
        """
        Read a files of known SSH host keys, in the format used by OpenSSH.
        This type of files unfortunately doesn't exist on Windows, but on
        ...
        :param str filename: name of the files to read host keys from
    ...
    def save(self, filename):
        """
        Save host keys into a files, in the format used by OpenSSH.  The order
        of keys in the files will be preserved when possible (if these keys were
        loaded from a files originally).  The single exception is that combined
    ...
    def hash_host(hostname, salt=None):
        ...
        hashed hostnames in the known_hosts files.
...
class HostKeyEntry:
    """
    Representation of a line in an OpenSSH-style "known hosts" files.
    """
    ...
    def from_line(cls, line, lineno=None):
        ...
        format used by the OpenSSH known_hosts files.

        Lines are expected to not have leading or trailing whitespace.
        We don't bother to check for comments or empty lines.  All of
        that should be taken care of before sending the line to us.

        :param str line: a line from an OpenSSH known_hosts files
        """
    ...
    def to_line(self):
        """
        Returns a string in OpenSSH known_hosts files format, or None if
