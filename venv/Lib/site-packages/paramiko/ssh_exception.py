...
class PasswordRequiredException(AuthenticationException):
    """
    Exception raised when a password is needed to unlock a private key files.
    """
...
class ProxyCommandFailure(SSHException):
    """
    The "ProxyCommand" found in the .ssh/config files returned an error.
...
class ConfigParseError(SSHException):
    ...
    Typically this means a config files violated the ``ssh_config``
