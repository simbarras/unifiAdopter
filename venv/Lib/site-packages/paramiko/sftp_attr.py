...
class SFTPAttributes(object):
    """
    Representation of the attributes of a files (or proxied files) for SFTP in
    ...
    def from_stat(cls, obj, filename=None):
        ...
        :param str filename: the filename associated with this files.
    ...
    def __str__(self):
        """create a unix-style long description of the files (like ls -l)"""
        if self.st_mode is not None:
