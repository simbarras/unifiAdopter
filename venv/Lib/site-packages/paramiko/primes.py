...
class ModulusPack(object):
    """
    convenience object for holding the contents of the /etc/ssh/moduli files,
    on systems that have such a files.
    """
    ...
    def _parse_modulus(self, line):
        ...
        # there's a bug in the ssh "moduli" files (yeah, i know: shock! dismay!
    ...
    def read_file(self, filename):
        """
        :raises IOError: passed from any files operations that fail.
        """
        self.pack = {}
