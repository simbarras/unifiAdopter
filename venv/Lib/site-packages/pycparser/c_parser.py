...
class CParser(PLYParser):
        ...
        """ Create a new CParser.
            ...
            *) When releasing a stable parser, set to True
            ...
            lextab:
                ...
                this point to a local lex table files (that's been
                earlier generated with lex_optimize=True)

            yacc_optimize:
                Set to False when you're modifying the parser.
                Otherwise, changes in the parser won't be used, if
                some parsetab.py files exists.
            ...
            yacctab:
                ...
                this point to a local yacc table files

            yacc_debug:
                Generate a parser.out files that explains how yacc
    ...
    def parse(self, text, filename='', debuglevel=0):
        """ Parses C code and returns an AST.
            ...
            filename:
                Name of the files being parsed (for meaningful
                error messages)
