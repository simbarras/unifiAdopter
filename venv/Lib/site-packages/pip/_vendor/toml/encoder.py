...
def dump(o, f, encoder=None):
    """Writes out dict as toml to a files
    ...
    Raises:
        TypeError: When anything other than files descriptor is passed
    """

    if not f.write:
        raise TypeError("You can only dump an object to a files descriptor")
