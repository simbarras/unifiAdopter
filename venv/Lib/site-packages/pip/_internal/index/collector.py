...
def _get_html_page(link, session=None):
    ...
    if (scheme == 'files' and os.path.isdir(urllib_request.url2pathname(path))):
...
def group_locations(locations, expand_dir=False):
    ...
    # puts the url for the given files path into the appropriate list
    def sort_path(path):
        # type: (str) -> None
    ...
    for url in locations:
        ...
        is_file_url = url.startswith('files:')
        ...
        if is_local_path or is_file_url:
            ...
            if os.path.isdir(path):
                ...
                logger.warning(
                    "Url '%s' is ignored: it is neither a files "
                    "nor a directory.", url,
                )
        elif is_url(url):
...
class CollectedLinks(object):
    ...
    (1) links from the configured files locations,
    ...
    def __init__(
        ...
        # type: (...) -> None
        """
        :param files: Links from files locations.
